! function(e) {
	...
	a(2), a(3), a(4), a(5), a(6), MI.checkout = function() {
		...
		function r(e) {
			var t = doT.template($("#J_newAddressTemplate").html()),
				a = t(e);
		...
		function n(e) {
			if(e) {
				var t = "*",
					a = $("#J_addressList").find(".selected"),
					i = a.offset(),
					o = $(".J_confirmBigProTip"),
					r = $("#J_popBigProTip"),
					s = $("#J_checkoutToPay");
		...
		function c(e) {
			if(e) {
				...
				var t = $('.J_option[data-type="pay"]').parent(".J_optionList"),
					o = "";
		...
		function f() {
			var e = checkoutConfig.postage,
				t = checkoutConfig.totalPrice - w.couponInfo.couponPrice;
		...
		function m() {
			$(".J_raiseBuyItem").on("click", function(e) {
				var t = L.parseJson($(this).attr("data-info")),
				...
				var e = $(this).parent().parent(),
					t = L.parseJson(e.attr("data-info")),
		...
		function g(e, t, a, i) {
			var o = MI.GLOBAL_CONFIG.cartSite + "/cart/addCartActivity.php",
				r = {
					...
					productid: i.attr("data-productid")
				};
			$.ajax({
				url: o,
				dataType: "jsonp",
		...
		function v(e, t) {
			...
			var a = $(e),
				i = a.find(".J_chooseProList"),
				o = a.find(".J_chooseProBtn"),
				r = a.attr("data-isadd") || !1,
			...
			a.addClass("modal-choose-pro-" + n), a.on("shown.bs.modal", function() {
				...
				backdrop: "static",
				show: !0
			}).removeClass("hide").on("hide.bs.modal", function() {}), i.children("li").on("click", function() {
				$(this).addClass("selected").siblings().removeClass("selected");
				...
				var e = i.find(".selected").attr("data-gid"),
					o = i.find(".selected").attr("data-productid");
		...
		function k() {
			...
			e.on("click", function() {
				...
				var o = window.doT.template($("#J_agreementTmp").html()),
					r = $(this).data("infor");
				$("#J_modalAgreement").modal("show").html(o(r))
			}), e.on("click", ".J_del", function() {
				var e = $(this).parent().parent(),
					t = e.attr("data-itemid");
				t && _(t, e)
		...
		function y(e) {
			var t = doT.template($("#J_checkoutGoodsTemplate").html()),
				a = t(e.items);
			$("#J_goodsList").html(a);
			var i = doT.template($("#J_checkoutMoneyTemplate").html()),
				o = i(e);
		...
		function b() {
			...
			if("1" === checkoutConfig.showCaptcha) {
				var t = $("#J_captchaToken").val(),
					a = $.trim($("#captcha_code").val());
		...
		function I(e) {
			if(e) {
				...
				var t = doT.template($("#J_tipGoodsTemplate").html()),
					a = t(e);
		...
		function A() {
			...
			$("#captcha_code").on("blur", function() {
				var e = $.trim($(this).val()),
					a = $(this).attr("data-authurl"),
					i = a.replace("{answer}", e);
				e ? $.ajax({
					type: "post",
					url: i + "&v=" + Math.random(),
					dataType: "jsonp",
		...
		var w = {
			...
			M = {
				...
				showBox: function(e) {
					...
					if(a) {
						var i = $("#J_ecardBox"),
							...
							s = $("#J_recycleBox");
						t.config.cardType = o, i.css({
							top: r[o]
						}).removeClass("hide"), "normal" === o ? (i.find(".J_tabSwitch").removeClass("hide").find("li").eq(0).trigger("click"), i.find(".tab-container").removeClass("hide"), s.addClass("hide")) : "recycle" === o && (i.find(".J_tabSwitch, .tab-container").addClass("hide"), s.removeClass("hide"), $("#J_recycleList").removeClass("hide"));
				...
				setEcardInfo: function() {
					...
					var t = this,
						a = checkoutConfig.totalPrice + e - w.ecardAmount - w.couponInfo.couponPrice,
						i = $("#J_ecardInfo"),
						o = "礼品卡",
						r = '<span class="tip">（暂不支持抵扣运费、意外保、电话卡等）</span>';
				...
				checkEcardResult: function(e) {
					if(e) {
						var t, a = this,
							i = parseFloat(e.need_pay_amount) > 0 ? !0 : !1;
				...
				sendSms: function() {
					...
					"recycle" === e.config.cardType && (t = "huanxin_check"), $.ajax({
						...
						data: {
							sms_action: t,
							bts: w.bts,
							sms_token: e.config.smsToken ? e.config.smsToken : ""
						},
						timeout: 1e4,
						error: function() {
							L.tipMsg("抱歉！网络错误，请刷新重试！")
						...
						success: function(t) {
							if(e.toggleLoading(!1), t && 1 === t.code) {
								if(t.data.safe_mobile) {
									...
									var a, i = $("#J_smsCountdown"),
										o = $("#J_repeatSms"),
										r = $("#J_smsCountdown").find("i"),
										s = 60;
				...
				bindError: function(e) {
					var t = {
						60000010: {
							title: "您的账号未绑定安全手机！",
							desc: "为了您的资金安全，请前往小米账号中心绑定安全手机使用礼品卡支付时，需安全手机接收验证码"
						},
						100405: {
							title: "该礼品卡未激活或已绑定!",
							desc: "请联系购买人，确认订单收货并激活礼品卡，每个礼品卡密码只能被绑定一次，若已被绑定，将不能再次绑定。"
						},
						100404: {
							title: "输入的礼品卡号或密码有误！",
			...
			x = function() {
				$("#J_miniHeaderTitle").html("<h2>确认订单</h2>"), MI.form.init(), w.bts = $.cookie("xm_order_btauth") ? $.cookie("xm_order_btauth") : null, $("#J_addressList").on("click", ".J_addressItem", function(t) {
					...
					var e = $.trim($(this).val()),
						t = /^[A-Z0-9]{15}$|^[A-Z0-9]{17,18}$|^[A-Z0-9]{20}$/;
			...
			L = {
				tipMsg: function(e) {
					e ? $("#J_modalAlert").one("show.bs.modal", function() {
						...
						show: !0,
						backdrop: "static"
					}).removeClass("hide").one("hidden.bs.modal", function() {
				...
				tipMsgs: function(e) {
					e ? $("#J_modalAlert").addClass("modal-alerts").one("show.bs.modal", function() {
						...
						show: !0,
						backdrop: "static"
					}).removeClass("hide").one("hide.bs.modal", function() {
	...
	! function(e) {
		function t(t) {
			...
			var s, n, c, d, l, u, h, p, f, m, g, v, $, _ = e(this),
				k = 0,
				C = -1;
			return p = {
				itemSelector: "> li",
	...
	! function(e) {
		function t(a, i) {
			function o(e) {
				var t = "undefined" != typeof navigator ? navigator.userAgent : null,
					a = /iphone/i.test(t);
			...
			function d(t) {
				var a, i = e(t)[0];
				if("number" == typeof i.selectionStart) return {
					begin: i.selectionStart,
					end: i.selectionEnd
				};
				if(a = document.selection.createRange(), a && a.parentElement() === i) {
					...
					return o.moveToBookmark(a.getBookmark()), r.collapse(!1), o.compareEndPoints("StartToEnd", r) > -1 ? {
						...
						begin: -o.moveStart("character", -s),
						end: -o.moveEnd("character", -s)
					}
				}
				return {
					begin: 0,
			...
			function l(t, a) {
				var i = e(t)[0];
				if(i.setSelectionRange) i.focus(), i.setSelectionRange(a, a);
	...
	MI.checkUserRisk = function() {
		...
		function a() {
			var a = MI.GLOBAL_CONFIG.orderSite + "/risk/checkuser",
				o = $.cookie("miUserRiskToken") || "";
			$.ajax({
				type: "POST",
				url: a,
				dataType: "json",
	...
	a(7), MI.namespace("searchAddress"), MI.searchAddress = {
		...
		init: function() {
			...
			this.userAddress = {}, this.editOptions = {
				...
				var t = $.trim($(this).val()),
					a = "four_address" === $(this).attr("name") ? !0 : !1;
				t && !a && e.validation($(this))
			})
		},
		buildDom: function() {
			var e = multiline(function() {
				/*!@tpl
		...
		selectEvent: function() {
			...
			e.$selectWrapper.on("click.seladdr", ".J_select", function() {
				...
				var a = parseInt($(this).attr("data-value")),
					i = $(this).attr("data-txt"),
					o = $(this).attr("data-zipcode") || "",
					r = t + 1,
					s = e.$selectWrapper.find(".J_select").eq(r);
				return e.result[t] = {
					id: a,
					name: i,
					zcode: o
