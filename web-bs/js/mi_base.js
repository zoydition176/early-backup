		...
		getHdget: function() {
			...
			$.ajax({
				...
				error: function(t, i, r) {
					...
					return o.locationHref = window.location.href, o.errorData = t, o.errorType = i, o.error = r, _msq.push(["trackEvent", "AJAX_ERROR", encodeURIComponent(n), JSON.stringify(o)]), e.inTheQueue ? (e.stopQueue(),
						void $(e.config.modalError).modal({
							show: !0,
							backdrop: "static"
						}).removeClass("hide")) : !1
				},
